...
namespace TherapyItemRecSys.Classes
{
    class CUser
    {
        ...
        public void loadTherapyBlocks()
        {
            ...
            // check if file exists
            //string strXmlFile = m_strAppPath + "user_" + m_strUserId + "_therapyblocks_r" + m_intRoundIdx + ".xml";
        ...
        public void saveTherapyBlocksToXml()
        {
			...
			*/
            ...
            for (int i = 0; i < m_lsTherapyBlock.Count; i++)
            {
                ...
                xmlChild2.InnerText = m_lsTherapyBlock[i].m_dtStartTime.ToString("yyyy-MM-dd HH:mm:ss"); //System.DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
                xmlNode.AppendChild(xmlChild2);

                xmlChild2 = doc.CreateElement("eTime");
                xmlChild2.InnerText = m_lsTherapyBlock[i].m_dtEndTime.ToString("yyyy-MM-dd HH:mm:ss");
                xmlNode.AppendChild(xmlChild2);
