...
namespace TherapyItemRecSys.Classes
{
    class CDataset
    {
        ...
        // loadDataset
        //----------------------------------------------------------------------------------------------------
        public void loadDataset(int intDatasetId)
        {
            m_intDatasetId = intDatasetId;
            if (m_intDatasetId == 0)
            {              
                m_strFile_LexicalItem_Xml = "setA_stimuli_lexicalitems_all.xml";  //"stimuli_noun_verb_lexicalitems.xml";
                m_strFile_ChallengeItem_Xml = "setA_stimuli_challengeitems_all.xml";  //"stimuli_noun_verb_challengeitems.xml";
                m_strFile_ChallengeItemFeature_Csv = "setA_stimuli_challengeitemfeatures_all.csv";  //"stimuli_noun_verb_challengeitemfeatures.csv";
                m_strFile_ChallengeItemFeatureNeighbours_Csv = "setA_stimuli_challengeitemfeatures_neighbours_all_30.csv";  //"stimuli_noun_verb_challengeitemfeatures_neighbours.csv";
                m_strFile_ChallengeItemFeatureForced_Csv = "setA_stimuli_challengeitemfeatures_forced_all.csv";  //"stimuli_noun_verb_challengeitemfeatures_forced.csv";
                m_strFile_ChallengeItemFeatureStarterPool_Csv = "setA_stimuli_challengeitemfeatures_starterpool.csv";
                m_strFile_ChallengeItemFeatureMedianPool_Csv = "setA_stimuli_challengeitemfeatures_medianpool.csv";
            }
            else
            {
                m_strFile_LexicalItem_Xml = "setB_stimuli_lexicalitems_all.xml";
                m_strFile_ChallengeItem_Xml = "setB_stimuli_challengeitems_all.xml";
                m_strFile_ChallengeItemFeature_Csv = "setB_stimuli_challengeitemfeatures_all.csv";
                m_strFile_ChallengeItemFeatureNeighbours_Csv = "setB_stimuli_challengeitemfeatures_neighbours_all_30.csv";
                m_strFile_ChallengeItemFeatureForced_Csv = "setB_stimuli_challengeitemfeatures_forced_all.csv";
                m_strFile_ChallengeItemFeatureStarterPool_Csv = "setB_stimuli_challengeitemfeatures_starterpool.csv";
                m_strFile_ChallengeItemFeatureMedianPool_Csv = "setB_stimuli_challengeitemfeatures_medianpool.csv";
            }
